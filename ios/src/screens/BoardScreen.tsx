      ...
      <View style={styles.cardBottomRow}>
        ...
        <View style={styles.quantityRow}>
          <View
            style={[
              styles.quantityDot,
              { backgroundColor: strawberry.isPreOrder ? strawberry.freshnessColor : '#2D8A2D' },
            ]}
          />
          <Text style={[styles.quantityLabel, strawberry.isPreOrder && { color: strawberry.freshnessColor }]}>
...
export default function BoardScreen() {
  ...
  const handleOrder = (strawberry: Strawberry) => {
    setVariety(VARIETY_ID_MAP[strawberry.name] ?? 0, strawberry.name);
